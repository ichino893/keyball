...
const uint16_t PROGMEM my_left[]   = {KC_J, KC_K, COMBO_END};     // M + , (元に戻しました)
const uint16_t PROGMEM my_up[]     = {KC_K, KC_I, COMBO_END};     // K + , (元に戻しました)
const uint16_t PROGMEM my_right[]  = {KC_K, KC_L, COMBO_END};     // , + . (元に戻しました)
const uint16_t PROGMEM my_down[]   = {KC_K, KC_COMM, COMBO_END};  // . + / (元に戻しました)
